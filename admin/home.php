...
<div class="logo"><a href="home.php" title="" style="line-height: 40px;font-size:24px; color:#fff;padding-left:15px;">管理系统</a></div>
...
<li appfile="call"><a href="javascript:$.win('数据调用','data_use.php');void(0);"><span class="icon-rocket"></span>数据调用</a></li>
